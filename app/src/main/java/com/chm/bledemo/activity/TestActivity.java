    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBleController.RegistReciveListener(TAG, new OnReceiverCallback() {
            ...
            public void onReceiver(byte[] value) {
                System.out.println(HexUtil.bytesToHexString(value));
//                tvMsg.setText(HexUtil.bytesToHexString(value));
            }
        });

        Button a = findViewById(R.id.btn_down);
        Button b = findViewById(R.id.btn_pause);
        Button c = findViewById(R.id.btn_up);
